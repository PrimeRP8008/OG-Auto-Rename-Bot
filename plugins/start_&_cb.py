...
async def start(client, message):
    ...
    button = InlineKeyboardMarkup([[
      InlineKeyboardButton('📢 Updates', url='https://t.me/CodeifyBots),
      InlineKeyboardButton('💬 Support', url='https://t.me/+H5X2Wlj8DZo3NTY1')
    ],[
      InlineKeyboardButton('⚙️ Help', callback_data='help'),
      InlineKeyboardButton('💙 About', callback_data='about')
    ],[
        InlineKeyboardButton("🧑‍💻 Developer 🧑‍💻", url='https://t.me/TgContactxBot)
    ]])
    if Config.START_PIC:
